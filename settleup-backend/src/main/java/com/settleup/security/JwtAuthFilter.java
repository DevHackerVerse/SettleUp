...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            log.debug("JWT filter error — invalid token: {}", e.getMessage());
            // Don't throw — let the request proceed unauthenticated;
            // the security filter chain will reject it at the endpoint level.
        }
